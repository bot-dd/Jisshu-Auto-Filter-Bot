...
# Owners 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7945551029 7822720438').split()]
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'RahatMx') # without @ or https://t.me/ 
USERNAME = environ.get('USERNAME', "NeoFrd") # ADMIN USERNAME

# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002267680129').split()]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002274084870'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002238603343'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002390337330'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002390337330')) 
...
START_IMG = (environ.get('START_IMG', 'https://i.imgur.com/guEvzDv.jpeg https://i.imgur.com/zKlyLF7.jpeg https://i.imgur.com/EO0ef2V.jpeg https://i.imgur.com/j6J9Dlj.jpeg https://i.imgur.com/eanliJA.jpeg')).split()
...
TMDB_API_KEY = environ.get("TMDB_API_KEY", "252ce4f9b28effb7b4e67d41bfedc51d")
